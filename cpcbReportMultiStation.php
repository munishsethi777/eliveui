...
var options = Highcharts.setOptions(Highcharts.theme);
   ...
   // var options;
    ...
    $(document).ready(function(){
        ...
        <?}else{?>
            getStationsByLocation(<?echo $locSeqParam?>,"AQMS");
        <?}?>
    ...
    function getAllLocationsAndStations(){
        $.getJSON("ajax_cpcb.php?method=requestAllLocationsAndStationsJSON&folderType=AQMS",function(data){
            $(".locationsSelectDiv").html("<select class='locationsSelect' name='locationsSelect' onChange='locationChange(\"AQMS\")'></select>");
...
<div style="margin:auto;width:1200px;min-height:250px;margin-top:3px;padding:4px;" class="ui-widget-content">
    ...
    <div id="searchTabs" style="width:330px;padding:5px;float:right">
        ...
        <div id="advanceSearch" style="padding:10px;width:auto;height:auto">
            ...
            <label class="isAverage"><input type="checkbox" id="isAverage" name="isAverage" />Average</label><br />
            <label class="formLabel">Value Type :</label>
